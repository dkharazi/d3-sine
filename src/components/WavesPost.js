...
function WavesPost() {
  return (
    <div className="wrap">
        ...
        <img src={hierarchy} alt="hierarchy" className={postStyles.image} />
        <p>
        ...
        <img src={frequency} alt="frequencyRange" className={postStyles.image} />
        <p>
        ...
        <img src={structure} alt="waveStructure" className={postStyles.image} />
        <p>
